...
void main() => runApp(ReadNewsText(null, null, ""));

class ReadNewsText extends StatefulWidget {
  final context, string, news;
  const ReadNewsText(this.context, this.string, this.news);

  @override
  ReadNewsTextState createState() => ReadNewsTextState();
}

class ReadNewsTextState extends State<ReadNewsText> {
  @override
  void initState() {
    super.initState();
  }
