...
void main() => runApp(ReadNewsVideo(null, null, ""));

class ReadNewsVideo extends StatefulWidget {
  final context, string, news;
  const ReadNewsVideo(this.context, this.string, this.news);

  @override
  ReadNewsVideoState createState() => ReadNewsVideoState();
}

class ReadNewsVideoState extends State<ReadNewsVideo> {
  @override
  void initState() {
    super.initState();
  }
